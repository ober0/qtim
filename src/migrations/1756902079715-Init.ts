...
export class Init1756902079715 implements MigrationInterface {
    name = 'Init1756902079715'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "frontendId" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "passwordId" uuid NOT NULL, "personId" uuid NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_0931de3dc012d9c091a1c5aeda7" UNIQUE ("frontendId"), CONSTRAINT "UQ_93f4fce053c521db024444e928d" UNIQUE ("passwordId"), CONSTRAINT "UQ_ddd0d20e45dbd0d1536dc082039" UNIQUE ("personId"), CONSTRAINT "REL_93f4fce053c521db024444e928" UNIQUE ("passwordId"), CONSTRAINT "REL_ddd0d20e45dbd0d1536dc08203" UNIQUE ("personId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
